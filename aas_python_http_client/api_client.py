...
import aas_python_http_client.models
from aas_python_http_client import rest
...
class ApiClient(object):
    ...
    def sanitize_for_serialization(self, obj):
        ...
        elif (hasattr(aas_python_http_client.models, type(obj).__name__) and
              getattr(aas_python_http_client.models, type(obj).__name__) is type(obj)):
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aas_python_http_client.models, klass)
