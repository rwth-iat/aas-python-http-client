...
import six
from aas_python_http_client.models.reference_parent import ReferenceParent  # noqa: F401,E501
...
class Reference(ReferenceParent):
    ...
    if hasattr(ReferenceParent, "swagger_types"):
        swagger_types.update(ReferenceParent.swagger_types)

    attribute_map = {
        'referred_semantic_id': 'referredSemanticId'
    }
    if hasattr(ReferenceParent, "attribute_map"):
        attribute_map.update(ReferenceParent.attribute_map)

    def __init__(self, referred_semantic_id=None, *args, **kwargs):  # noqa: E501
        """Reference - a model defined in Swagger"""  # noqa: E501
        self._referred_semantic_id = None
        self.discriminator = None
        if referred_semantic_id is not None:
            self.referred_semantic_id = referred_semantic_id
        ReferenceParent.__init__(self, *args, **kwargs)

    @property
    def referred_semantic_id(self):
        """Gets the referred_semantic_id of this Reference.  # noqa: E501


        :return: The referred_semantic_id of this Reference.  # noqa: E501
        :rtype: ReferenceParent
        """
        return self._referred_semantic_id

    @referred_semantic_id.setter
    def referred_semantic_id(self, referred_semantic_id):
