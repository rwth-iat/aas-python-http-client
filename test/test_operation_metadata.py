...
from aas_python_http_client.models.operation_metadata import OperationMetadata  # noqa: E501
...
class TestOperationMetadata(unittest.TestCase):
    ...
    def testOperationMetadata(self):
        ...
        # model = swagger_client.models.operation_metadata.OperationMetadata()  # noqa: E501
        pass
