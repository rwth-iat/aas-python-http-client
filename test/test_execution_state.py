...
from aas_python_http_client.models.execution_state import ExecutionState  # noqa: E501
...
class TestExecutionState(unittest.TestCase):
    ...
    def testExecutionState(self):
        ...
        # model = swagger_client.models.execution_state.ExecutionState()  # noqa: E501
        pass
